...
import {
  CATEGORY_MEANS, CATEGORY_ORDER, CATEGORY_COLORS,
  CATEGORY_BG_CLASSES, CATEGORY_CSS_CLASSES,
  SYNTHESIS_SUMMARY, PS_NOTE, formatDimName,
} from '@/lib/constants';
...
const HomeView: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const speed = 25;
    const tick = () => {
      if (i < SYNTHESIS_SUMMARY.length) {
        setTypedText(SYNTHESIS_SUMMARY.slice(0, i + 1));
        i++;
  ...
  const skipTyping = useCallback(() => {
    if (!typingDone) {
      ...
      setTypedText(SYNTHESIS_SUMMARY);
      setTypingDone(true);
    }
  }, [typingDone]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden">
      <div className="flex items-center gap-8 max-w-5xl w-full flex-col lg:flex-row">
          ...
          <div className="relative z-10 mb-6">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-1 font-mono text-[11px]">
              <div>
                ...
                <span className="text-foreground">QWEN/QWEN2.5-0.5B-INSTRUCT</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span className="text-foreground">2026-03-20</span>
              </div>
              <div>
              ...
              {CATEGORY_ORDER.map(cat => (
                <div key={cat} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-2 bg-white/[0.05] rounded-full overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: `${CATEGORY_MEANS[cat] * 100}%` }}
        ...
        {/* Wen floating character — right side */}
        <motion.div
